...
class Function extends React.PureComponent {
    ...
    handleTableChange = (pagination, filters, sorter) => {
      console.log('Function  table 表格 分页、排序、筛选变化时触发 pagination----', pagination);
      console.log('Function  table 表格 分页、排序、筛选变化时触发 filters----', filters);
      console.log('Function  table 表格 分页、排序、筛选变化时触发 sorter----', sorter);
    ...
    editFunction = (record) => {
      ...
      console.log('let openMenuList = util.openTreeData(menuList);', openMenuList);
      let menuWithParent = util.getTreeEleWithParent(record.moduleId, openMenuList);
      console.log('let menuWithParent = util.getTreeEleWithParent(record.moduleId, openMenuList);', record.moduleId, menuWithParent);
    ...
    saveFunction = async (data) => {
      ...
      } catch (e) { console.log('saveFunction', e); }
      this.refresh();
    }
